...
CREATE TABLE tx_seoassistant_impact_evaluation (
    uid int(11) unsigned NOT NULL auto_increment,
    pid int(11) DEFAULT '0' NOT NULL,
    tstamp int(11) unsigned DEFAULT '0' NOT NULL,
    crdate int(11) unsigned DEFAULT '0' NOT NULL,
    ...
    query_text varchar(1024) DEFAULT '' NOT NULL,
    applied_at int(11) unsigned DEFAULT '0' NOT NULL,
    before_from int(11) unsigned DEFAULT '0' NOT NULL,
    before_to int(11) unsigned DEFAULT '0' NOT NULL,
    after_from int(11) unsigned DEFAULT '0' NOT NULL,
    ...
    before_position double DEFAULT '0' NOT NULL,
    after_clicks double DEFAULT '0' NOT NULL,
    after_impressions double DEFAULT '0' NOT NULL,
    after_ctr double DEFAULT '0' NOT NULL,
    after_position double DEFAULT '0' NOT NULL,
    clicks_delta double DEFAULT '0' NOT NULL,
    impressions_delta double DEFAULT '0' NOT NULL,
    ctr_delta double DEFAULT '0' NOT NULL,
    position_delta double DEFAULT '0' NOT NULL,
    impact_status varchar(32) DEFAULT 'pending' NOT NULL,
    confidence varchar(16) DEFAULT 'low' NOT NULL,
    ai_summary text,
    ai_next_action text,
    ai_model varchar(128) DEFAULT '' NOT NULL,
    evidence_json mediumtext,
    evaluation_hash varchar(64) DEFAULT '' NOT NULL,

    PRIMARY KEY (uid),
    UNIQUE KEY evaluation_hash (evaluation_hash),
